...
summary: Hook:en useState är bra till mycket. Men ibland räcker den inte hela vägen. Det här är lite reflektioner över första gången jag använde useReducer för att lösa lite mer avancerad state.
date: 2021-02-13

...
Detta är något jag fick användning av efter att sajten rullat hos Vercel endast några dagar. Jag upptäckte en bugg när jag testade responsiviten på min iPad i ett [slide over fönster](https://support.apple.com/sv-se/guide/ipad/ipadfe7c65e9/ipados) och flödet för buggfixen såg ut såhär:

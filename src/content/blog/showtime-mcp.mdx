...
Efter att ha byggt en [MCP-server för Bear notes](/blogg/en-mcp-server-for-bear-notes) ville jag testa något lite mer ambitiöst. Samtidigt hade jag sett lite buzz kring OpenCode och var nyfiken på vad grejen var. Så jag slog ihop de två sakerna: bygga en MCP-server för film- och TV-data, och göra det helt i OpenCode.

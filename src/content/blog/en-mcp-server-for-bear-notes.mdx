...
category: AI
preamble: 'Hur en iOS-genväg för elräkningar blev en MCP-server som låter Claude prata med mina anteckningar.'
---
...
Så jag byggde en MCP-server istället, mest genom att prompta Claude. Nu kan Claude Code prata direkt med Bear.

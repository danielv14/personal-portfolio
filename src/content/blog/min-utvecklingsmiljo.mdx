...
**OBS: Absolut ingenting i denna bloggpost stämmer längre då min utvecklingsmiljö har ändrats avsevärt sedan 2017. Dock är det intressant att notera att jag 2017 började snegla på VS Code, vilket jag nu använder dagligen flera år senare. Det är ändå kul att ha kvar inlägget för att se hur jag jobbade för 8 år sedan.**
...
När jag utvecklar i Atom med Material Design UI tema, Dracula syntaxtema och Source Code Pro som font kan det se ut ungefär såhär:
![iTerm](../../assets/posts/Atom.png)

## Homebrew

> Den efterlängtade pakethanteraren för macOS

Såhär beskrivs Homebrew på den officiella [hemsidan](https://brew.sh/) och det är precis det som Homebrew är. Vet man om linux eller har använt någon linuxdistribution så kanske man vet om att det i linuxvärlden finns olika pakethanterare för att bland annat installera och underhålla diverse program, många gånger via terminalen.
...
![iTerm](../../assets/posts/iTerm.png)

## Stacks, ramverk och liknande

Jag gillar att lära mig nya saker och skiftar ofta mellan olika stacks, kodar i olika språk och använder olika ramverk. Här presenterar jag de stacks, ramverk och dylikt som jag använder i mitt utvecklande.

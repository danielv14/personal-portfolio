...
Vad är det jag vill få sagt egentligen? Jo, att man många gånger kan kringgå blockers i projekt/sprintar genom att enas om det dataformat som då och då genomsyrar ett helt projekt eller en hel sprint.

...
För ett par veckor sedan byggde jag [The Frontpage Muse](https://frontpagemuse.danielwernberg.blog/) - en blogg där en AI varje dag läser igenom Hacker News, väljer ut det som verkar intressant, och sedan skriver ett inlägg med full kreativ frihet. Enda regeln är att samma HN-post inte får återkomma dagen efter.

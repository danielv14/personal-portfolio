...
```html title="_includes/sections/projects.html" {7} showLineNumbers
...
```html title="_includes/_portfolioCard.html" showLineNumbers
...
En lördag-söndag-måndagskväll senare och denna sajt var deployad via **Vercel**. Alla ompekningar var gjorda och [danielwernberg.blog](https://danielwernberg.blog) fick sig ett ansiktslyft både utvändigt och invändigt.

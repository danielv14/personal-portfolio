...
Jag har tidigare [skrivit](/blogg/node-cli-for-att-skrapa-imdb) lite om det node-baserade CLI verktyg jag skapade för att enkelt komma åt filmers och tv-seriers "IMDb ID:n". Nu har jag använt version 1.0.1 av verktyget sen i septemper 2017 och kände att det var dags att göra CLI:t mer flexibelt, då jag av och till kände att det var viss funktionalitet som saknades.
...
![IMDB-cli-help](../../assets/posts/imdb-help-text.png)
...
```js title="example-cli.js" showLineNumbers
...
![IMDB-jest-test](../../assets/posts/imdb-jest-test.png)
...
![IMDB-cli-in-action](../../assets/posts/imdb-cli-in-action.png)

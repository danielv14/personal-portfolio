...
Det är AI som summerar AI-summeringar av AI-hämtad data. Varje lager bygger på det föregående. Och varje lager kan tappa nyanser. Jag har märkt att sammanfattningarna ibland missar kontext som jag minns men som inte fanns i datan — diskussioner som fördes i Slack, beslut som togs muntligt. Det blir en selektiv bild av vad jag faktiskt gjorde.

...
För ett tag sedan lanserade jag de första releaserna ([1.0.0](https://github.com/danielv14/ColorPix/releases/tag/v1.0.0) och [1.0.1](https://github.com/danielv14/ColorPix/releases/tag/v.1.0.1)) för ColorPix - en webbapp som hjälper användare att upptäcka färgpaletter via bilder från Unsplash. Applikationen genererar färgpaletter utifrån bildernas dominanta färger och låter även användare finjustera färgmättnad och ljusstyrka.
Justeringen av färgpaletterna görs med olika reglage och jag tänkte gå igenom lite förändringar UX-mässigt som gjorts i och med release 1.1.0 - där en ”_less is more_” approach har förenklat samt förbättrat färgmanipuleringen i ColorPix.
...
![Gränssnitt-version-1-0-1](../../assets/posts/colorpix-ux-before.png)

_Bilden visar manipuleringsvertyget i version 1.0.1_

### Begränsningar

Vad finns det för begränsningar med gränssnittet i bilden ovan? På rak arm utifrån punktlistan ovan för hur användaren nyttjar verktygen samt skärmbilden för version 1.0.1 kunde jag identifiera följande begränsningar:
...
Fyra begränsningar och två möjligheter identifierade jag efter att ha använt ColorPix själv sporadiskt i ungefär en månads tid. Sammanfattningsvis kände jag mig begränsad av hur manipuleringsvektyget var utformat och jag kände att jag behövde ta tag i de identifierade begränsningarna för att skapa en bättre användarupplevelse.

![Gränssnitt-version-1-1-0](../../assets/posts/colorpix-ux-after.png)
...
I och med att reglagen och färgrepresentationerna inte längre är lika hårt knutna i kodbasen går det att låta flera reglage påverka en och samma färgåtergivning. Detta innebär att användaren kan justera exempelvis ökning av färgmättnad samtidigt som en minskning av ljusstyrka.

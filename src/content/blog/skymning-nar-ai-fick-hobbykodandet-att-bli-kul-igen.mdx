...
category: AI
preamble: 'En reflektion över julledigheten, promptandet, och att hitta tillbaka till något jag trodde jag tappat.'
---
...
Jag är förmodligen sen på bollen. Många har jobbat så här längre än jag. Men för mig är det nytt.
...
Jag valde det här projektet för att jag ville använda det jag byggde. Och för att testa att prompta fram något med en riktig frontend, inte bara backend-servrar som mina MCP-projekt.
...
Bun visade sig passa det här arbetssättet bra. Ingen byggkedja för TypeScript, inbyggt stöd för SQLite. Smidigt när man vill prototypa snabbt utan att konfigurera en massa. Opus 4.5 träffade rätt oftare än jag förväntat mig, men det hände att jag fick backa och omformulera när resultatet spårade iväg.

På jobbet finns processer som saktar ner saker. Code review, diskussioner, planering. Allt det som gör att saker tar den tid de tar. Hemma kunde jag hoppa över allt det. Prompta, se resultatet, prompta igen. Istället för att vänta på en mänsklig kollega hade jag ett slash-kommando i OpenCode för code reviews som användes flitigt. Det funkar för hobbyprojekt. På jobbet hade det inte räckt.
...
Det har förändrat hur jag ser på hobbyprojekt, och börjar förändra hur jag ser på kod på jobbet också.

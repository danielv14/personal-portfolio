...
summary: Skapa återanvändbara middlewares för API-endpoints i Next.js.
date: 2020-07-09
...
```js title="pages/api/users.js" showLineNumbers
// Fake users data
...
Med `export default` exporterar man en funktion som Next.js behind-the-scenes mappar mot en url och funktionen kommer anropas när man curl:ar:
...
```js title="pages/api/scrape.js" showLineNumbers
...
```js title="middlewares/withAuthorization.js" showLineNumbers
...
```js title="pages/api/scrape.js" {12,13} showLineNumbers

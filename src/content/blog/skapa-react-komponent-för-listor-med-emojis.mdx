...
Var det superkomplicerat? Nej. Var det revolutionerande? Knappast. Men syftet med den här sajten är delvis att jag ska ha en lättillgänglig yta att experimentera på och de här två komponenterna fyller det syftet.

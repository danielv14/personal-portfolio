...
summary: Skapa en EmojiList-komponent med emojis istället för list-bullets.
...
Var det superkomplicerat? Njae. Var det revolutionerande? Nope. Men syftet med den här sajten är _delvis_ att jag ska ha en lättillgänglig yta att <FunText>testa roliga grejer</FunText> och de här två komponenterna är ju ändå lite kul 🎉

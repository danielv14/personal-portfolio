...
summary: För ett tag sedan gjorde Aftonbladet ganska stora ändringar på sin startsida som resulterade till att en av mina sajter i princip vart värdelösa. Men det är helt okej!
layout: blogPost
date: 2021-07-09
---
...
Jag har tidigare [skrivit lite](https://www.danielvernberg.se/blogg/att-vacka-liv-i-ett-3-ar-gammalt-projekt) om en sajt/scraper jag byggt - som via en api-endpoint parsa startsidan på Aftonbladet och sparar ned viss data om Aftonbladets startsida i Google Firebase.
...
## Ännu förre datapunkter efter ett tag
...
- (Nice to have) någon slags monitorering för att snabbare fånga om scrapern fångar ett avvikande antal datapunkter.

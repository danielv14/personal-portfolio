...
Ett dataformat kan ses som ett kontrakt mellan exempelvis en front- och backend. Att i ett tidigt stadie bestämma hur detta dataformat, eller kontrakt, ska se ut innebär att man kan jobba mer effektivt, hålla antalet blockers nere och mjuka upp beroenden och helt enkelt jobba med asynkront.
